...
//  ChatAppWithFirebase
//
//  Created by 加古原　冬弥 on 2020/09/07.
...
class SignUpViewController: UIViewController {
    ...
    @objc private func tappedAlreadyHaveAccountButton() {
        ...
        let loginViewCcntroller = storyboard.instantiateViewController(withIdentifier: "LoginViewController")
        self.navigationController?.pushViewController(loginViewCcntroller, animated: true)
    }
    ...
    @objc private func tappedRegisterButton() {
        ...
        let image = profileImageButton.imageView?.image ?? UIImage(named: "IMG_0984" )
